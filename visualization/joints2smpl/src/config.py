...
SMPL_MODEL_DIR = "./checkpoints/smpl_models/"
GMM_MODEL_DIR = "./visualization/joints2smpl/smpl_models/"
SMPL_MEAN_FILE = "./visualization/joints2smpl/smpl_models/neutral_smpl_mean_params.h5"
# for collsion 
Part_Seg_DIR = "./visualization/joints2smpl/smpl_models/smplx_parts_segm.pkl"